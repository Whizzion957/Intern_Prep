...
const MySubmissions = () => {
    ...
    const loadMySubmissions = async () => {
        try {
            const { data } = await questionAPI.getMySubmissions();
            setQuestions(data);
        } catch (error) {
    ...
    return (
        <div className="my-submissions-page">
            <div className="page-header">
                <div>
                    <h1>My Submissions</h1>
                    <p>Questions you've submitted or own</p>
                </div>
            ...
            {questions.length === 0 ? (
                <div className="empty-state">
                    ...
                    <p>You haven't submitted any questions yet. Share your interview experience to help others!</p>
